...
# 2. Criar a aplicação
app = Flask(__name__)
app.config['SECRET_KEY'] = 'chave-secreto-para-dev' # (Corrigido para 'secreto')
...
# 16. Rota para Finalizar OS (COM LÓGICA SAP 100%)
...
def finalizar_os(os_id):
    ...
    if request.method == 'POST':
        ...
        if tipo == 'reparado':
            ...
            # CORREÇÃO: Não salvar a observação de desistência
